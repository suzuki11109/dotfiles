...
* Todolist
** TODO flymake projects diagnostics number in modeline
** TODO eshell complete recent dir with consult-dir
** TODO rubocop settings
** TODO find file orderless?
** TODO projectile compile/shellcommand prompt show path
** TODO projectile bookmarks
