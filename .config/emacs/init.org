...
* Todolist
** TODO if in project compile with project directory
** TODO markdown block
** TODO bundle init command
** TODO open history shell-command and run project or async command
** TODO ruby snippets
** TODO revisit consult-dir
