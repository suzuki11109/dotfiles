...
* Todolist
** TODO popper q quit
** TODO try disable gopls fuzzy and use orderless
** TODO rails console history
** TODO setup solargraph in project script
** TODO async-shell-command prefill
** TODO elfeed webkit
** TODO project bookmark+?
* Early init
** Startup performance
