...
* Todos
** gptel redirect response (from whole file or region) to new buffer
** org-roam
** hyperbole
** coding ai with local llm
** smartparens
** detached
** learn vocab (anki)
** plantuml
** impostman
** gptel directive for generate cli command in minibuffer ready to run
** agenda calendar
