...
#+AUTO_TANGLE: t
* Todos
** smerge normal-mode, insert-mode
** practice tramp in all scenarios docker, server, sftp
** face attribute vs custom faces
** put compile functions to a package compile-pro (project compile with project-specific compile-history)
** detache
** project bookmark
