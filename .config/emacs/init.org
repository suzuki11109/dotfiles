...
* Todolist
** key to Downloads directory
** remove branch from modeline
** markdown preview
** learn diff diff without creating files
** modeline name with path and command in eshell/eat
** run-command
** kele
** open new frame eshell
** extract tar/zip files
** key to list Downloads directory
** embark extract files
** ln -s
** tree
** debugging go
** ai
