...
(use-package eca
  ;; :custom-face
  ;; (eca-chat-usage-string-face ((t (:family (face-attribute 'fixed-pitch :family) :height 1.0 :box (:line-width 4 :color "black")))))
  :general
  (leader-def
    "aa" 'eca
...
;;   (agent-shell-display-action '+agent-shell-buffer-side-window)
;;   :general
;;   (leader-def
;;     "ag" 'agent-shell)
;;   (:states '(normal insert)
