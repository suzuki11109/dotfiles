...
myStartupHook = do
    ...
    spawn "sleep 2 && trayer --edge top --align right --widthtype request --height 50 --transparent true --alpha 0 --tint 0x282c34 --expand true --SetPartialStrut true --SetDockType true"
